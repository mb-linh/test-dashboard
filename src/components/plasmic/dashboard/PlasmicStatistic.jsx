...
import sty from "./PlasmicStatistic.module.css"; // plasmic-import: nH1BxDDFpqfi/css
...
function PlasmicStatistic__RenderFunc(props) {
  ...
  return (
    ...
    >
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__rsL7Y)}>
            <p
              className={classNames(
                projectcss.all,
                projectcss.p,
            ...
            <PlasmicImg__
              alt={""}
              className={classNames(sty.img__y5Vg8, {
                [sty.imghideIcon__y5Vg8AecI]: hasVariant(
                  $state,
                  "hideIcon",
                  "hideIcon"
                )
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__bwePj)}
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__dkt5C, {
            [sty.freeBoxhideIcon__dkt5CaecI]: hasVariant(
              $state,
              "hideIcon",
              "hideIcon"
            )
        ...
        <div className={classNames(projectcss.all, sty.freeBox__xglCt)}>
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__d8AFg, {
              [sty.freeBoxhideTrendTracker__d8AFGuGib7]: hasVariant(
                $state,
                "hideTrendTracker",
                "hideTrendTracker"
              )
          ...
          >
            <div
              className={classNames(projectcss.all, sty.freeBox__oaTsm, {
                [sty.freeBoxhideTrendTracker__oaTsmuGib7]: hasVariant(
                  $state,
                  "hideTrendTracker",
                  "hideTrendTracker"
                )
            ...
            >
              <div className={classNames(projectcss.all, sty.freeBox__ok2Mc)}>
                {renderPlasmicSlot({
            ...
            <div className={classNames(projectcss.all, sty.freeBox___0IhO)}>
              <div className={classNames(projectcss.all, sty.freeBox___62HBt)}>
                {renderPlasmicSlot({
