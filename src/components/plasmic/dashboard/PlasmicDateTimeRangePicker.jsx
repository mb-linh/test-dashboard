...
import sty from "./PlasmicDateTimeRangePicker.module.css"; // plasmic-import: srwHD4W5YwAX/css
            ...
            <React.Fragment>
              {(() => {
                const child$Props = {
                  ...
                  className: classNames(
                    "__wab_instance",
                    sty.dateTimePicker___2DBq8
                  ),
                  picker: "date",
                  popupScopeClassName:
                    sty["dateTimePicker___2DBq8__datePickerPopup"],
                  showTime: false
                };
              ...
              {(() => {
                const child$Props = {
                  ...
                  className: classNames(
                    "__wab_instance",
                    sty.dateTimePicker__zlp7B
                  ),
                  popupScopeClassName:
                    sty["dateTimePicker__zlp7B__datePickerPopup"],
                  showTime: false
                };
                return <AntdDatePicker {...child$Props} />;
              })()}
